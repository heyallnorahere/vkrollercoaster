...
namespace vkrollercoaster {
    enum class light_type { spotlight, point, directional };
    ...
    public:
        spotlight(const glm::vec3& direction, float cutoff, float outer_cutoff,
                  const attenuation_settings& attenuation = attenuation_settings());
